...
public class ProductDAO : IModelDAO<Product>
{
	...
	public ProductDAO(MySqlConnection connection, IEnumerable<Phone> phones, IEnumerable<Category> categories)
	{
	...
	{
		MySqlDataAdapter adapter = new("SELECT * FROM shop_products", _connection);
		_products = new();
	...
	public void Delete(int id)
	{
		...
		{
			DeleteCommand = new("DELETE FROM shop_products " +
	...
	public void Update(int id, Product newProduct)
	{
		...
		MySqlDataAdapter adapter = new()
		{
			UpdateCommand = new("UPDATE shop_products " +
	...
	public void Insert(Product product)
	{
		...
		MySqlDataAdapter adapter = new()
		{
			InsertCommand = new("INSERT INTO shop_products (`Name`, CategoryId, PhoneId, Price) " +
											"VALUES (@Name, @CategoryId, @PhoneId, @Price)", _connection)
		};
